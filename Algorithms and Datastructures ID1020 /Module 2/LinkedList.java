 ...
 * 
 * This code implements a linked list that holds elements of the type int. 
 * The elements is stored in ascending order. The output will print all the content of the elements 
 * after each enqueue operation. For example if the input is (2, 3, 1, 8, 6, 2) the output
 * is going to be: 
 * 
 * [2], [3], 
 *
